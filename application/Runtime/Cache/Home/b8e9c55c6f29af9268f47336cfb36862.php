			...
			<div class="ibox float-e-margins">
				...
				<div>
					<div class="ibox-content no-padding border-left-right">
						<img alt="image" class="img-responsive" src="<?php echo ($_SESSION['uinfo']['user_header']); ?>" style="width:200px;margin:5px auto;">
					</div>
					<div class="ibox-content profile-content">
						<h4><strong><?php echo ($_SESSION['uinfo']['user_nickname']); ?></strong></h4>
						...
						<div class="row m-t-lg">
							...
							<div class="col-sm-4">
								<h5><strong><?php echo ($_SESSION['uinfo']['user_cnum']); ?></strong> 关注</h5>
							</div>
							<div class="col-sm-4">
								<h5><strong><?php echo ($_SESSION['uinfo']['user_fnum']); ?></strong> 关注者</h5>
							</div>
						</div>
