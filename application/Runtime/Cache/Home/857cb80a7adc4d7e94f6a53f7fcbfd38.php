...
<body class="gray-bg">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="project-people">
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/Public/Common/img/a3.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/Public/Common/img/a1.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/Public/Common/img/a2.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/Public/Common/img/a4.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/Public/Common/img/a5.jpg"></a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="project-people">
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/Public/Common/img/a7.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/Public/Common/img/a6.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/Public/Common/img/a3.jpg"></a>
                                                </td>
                                                <td class="project-actions">
                                                    <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
    ...
    <!-- 自定义js -->
    <script src="/Public/Common/js/content.js"></script>
    <!--flotdemo-->
